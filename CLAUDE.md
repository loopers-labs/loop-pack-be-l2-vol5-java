...
| 문서 | 내용 |
|---|---|
| `docs/week2/plan.md` | 2주차 설계 — 정책(P-*), 규칙과 기대값(USR·BRD·PRD·LIK·PNT·ORD-*), API 계약, ADR, JPA 구현 메모, 테스트 경계 |
...
- 설계 문서 결정 표기: ✅ 합의 · 🔧 AI 기본값 · 🤔 결정 필요. 구현 중 판단이 바뀌면 `plan.md` 본문과 변경 이력을 함께 고친다.
