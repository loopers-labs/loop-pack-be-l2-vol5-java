...
| P-21 | 0원 사용·결제 요청 | **거절** — 정상 흐름(가격 ≥ 1, 수량 ≥ 1)에서 올 수 없는 값을 막는 방어 규칙 | ✅ |
...
| W-7 | 만료된 그룹만 있을 때 결제 | 거절 | 만료 그룹 사용 |
| W-8 | 남은 (Long 최댓값 − 1) 그룹이 있을 때 2원 충전 가능 여부 | 거절 (PNT-03 해석) | 넘침 무시 |
| W-9 | 0원 결제 | 거절 (P-21) | 0원 결제 허용 |
