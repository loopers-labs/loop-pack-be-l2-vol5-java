...
한 고객과 한 상품 사이의 좋아요는 하나다. 그래서 등록은 새로 만들거나 취소된 것을 되살린다. (INV-24)
...
하나의 참조가 가리키는 대상이 존재하고 유효한지는 여기에 속하지 않는다. 그 확인은 대상을 불러오는 일과 같고, 불러온 객체는 이어지는 동작이 그대로 쓴다. (INV-09, INV-23)
